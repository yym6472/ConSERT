...
def parse_args():
    ...
    parser.add_argument("--task", type=str, default="STS12,STS13,STS14,STS15,STS16,STSBenchmark,SICKRelatedness,MR,CR,SUBJ,MPQA,SST2,TREC,MRPC", help="The eval task")
...
if __name__ == "__main__":
    ...
    eval_senteval(args.model_path, args.task.upper().split(","), args)